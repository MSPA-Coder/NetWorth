...
from consolidado.papel_do_banco import VARIAVEL, conferir_papel
...
class _ConexaoFalsa:
    vendor = "postgresql"
    settings_dict = {"USER": "networth_app"}
...
def test_o_receptor_esta_ligado_ao_sinal_de_conexao():
    """Sem o `ready()` do consolidado, a trava existiria e nunca rodaria."""
    from django.db.backends.signals import connection_created

    estava_ligado = connection_created.disconnect(dispatch_uid="consolidado.conferir_papel")
