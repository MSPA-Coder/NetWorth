"""Preenche a série de câmbio até hoje.
...
class Command(BaseCommand):
    ...
    def _atualizar(self, moeda: str, inicio_pedido: date | None, hoje: date) -> None:
        ...
        if inicio > hoje:
            self.stdout.write(f"{moeda}: já está em dia (última em {ultima.data}).")
            return

        try:
            fechamentos = buscar_serie(moeda, MOEDA_BASE, inicio, hoje)
        ...
        self.stdout.write(
            ...
            f"(de {inicio} a {hoje}; última agora: "
